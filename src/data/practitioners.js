...
She brings the perspective of someone who has shipped at massive scale, navigating the complexities of enterprise organisations while maintaining the craft of engineering. Her path through IMD and INSEAD executive programmes adds a strategic lens to her technical depth.`,
  ...
  },
  {
    ...
    bio: `Anton is a 28-year-old computational physicist running the AI function at Simply.TV — the Danish B2B firm that supplies TV metadata to operators in roughly sixty countries. His company has just crossed a quietly historic threshold: 99-point-x-percent accuracy, on enough of its features, that his systems now handle work that once consumed thousands of editorial hours.
